...
has B<properties>, which normally translates to the hash keypair. Property names
normally translates to hash keys, while property values translates to hash
values. "Normally" is used here because property can have attributes:
